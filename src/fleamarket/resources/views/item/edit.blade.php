...
@section('content')
    <div class="container text-center mt-3" style="width:600px">
      <div class="row">
        ...
        <div class="col">
          <h2>商品の出品</h2>
          <form action="{{ route('item.edit', ['id' => $edit_products->id]) }}" method="post" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="update_product"value="{{$edit_products->id}}">
            <div class="d-flex flex-wrap">
              <div>出品画像</div>
              <input type="file" class="form-control" name="item_image" value="{{ $edit_products->item_image }}">
            </div>
            ...
            <div class="d-flex flex-wrap">
              ...
              <div class="form-group w-100">
                ...
                <option>{{ $edit_products->category }}</option>
                  <option>レディース</option>
                  <option>メンズ</option>
              ...
              <div class="form-group w-100">
                ...
                <option>{{ $edit_products->status }}</option>
            ...
            <div class="d-flex flex-wrap">
              <div>商品名</div>
              <div class="w-100">
                <input type="text" name="title" class="form-control" placeholder="商品名を入力してください"value="{{ $edit_products->title }}">
              </div>
              <div class="mt-3">商品の説明</div>
              <div class="w-100">
                <textarea class="form-control" name="content" style="height:200px">
{{ $edit_products->content }}
              </textarea>
            </div>
          </div>
          <h3 class="text-start mt-3">
          ...
          <div class="d-flex flex-wrap">
            ...
            <div class="form-group w-100">
              ...
              <option>{{ $edit_products->postage }}</option>
            ...
            <div class="form-group w-100">
              ...
              <option>{{ $edit_products->sender }}</option>
                <option>北海道</option>
                <option>青森県</option>
                <option>岩手県</option>
                <option>宮城県</option>
            ...
            <div class="form-group w-100">
              ...
              <option>{{ $edit_products->deliverytime }}</option>
          ...
          <div class="d-flex flex-wrap">
            ...
            <div class="w-100">
              <input type="text" name="prices" class="form-control" placeholder="数字のみ入れて下さい" value="{{ $edit_products->prices }}">
            </div>
          </div>
        </div>
        <button type="submit" name="update" class="btn btn-primary mt-5">更新</button>
      </form>
    </div>
  </div>
</div>
